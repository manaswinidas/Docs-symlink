...
.Default space
image::DMN/Getting-Started/Getting-started-with-decision-services/spaces-teams.png[]
...
image::DMN/Getting-Started/Getting-started-with-decision-services/dmn-new-project-gs.png[]
+
