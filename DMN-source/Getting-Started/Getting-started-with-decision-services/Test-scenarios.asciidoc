...
image::DMN/Getting-Started/Getting-started-with-decision-services/dmn-gs-traffic-violation-test-scenarios.png[]
...
image::DMN/Getting-Started/Getting-started-with-decision-services/dmn-gs-test-scenarios-execution-results.png[]
+
