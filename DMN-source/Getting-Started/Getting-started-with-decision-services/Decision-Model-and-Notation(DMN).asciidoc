...
image::DMN-source/Getting-Started/Getting-started-with-decision-services/dmn-traffic-violations-drd.png[]
...
image::DMN-source/Getting-Started/Getting-started-with-decision-services/dmn-custom-datatypes-tab.png[]
...
image::DMN-source/Getting-Started/Getting-started-with-decision-services/dmn-diagram-properties-tab.png[]
...
image::DMN-source/Getting-Started/Getting-started-with-decision-services/dmn-tDriver-custom-datatype.png[]
...
image::DMN-source/Getting-Started/Getting-started-with-decision-services/dmn-tViolation-custom-datatype.png[]
...
. To add the following constraints to the `Type` nested data type, click *Edit* -> *Constraints* -> *Enumeration* and add the following constraints. Click the check icon image:DMN-source/Getting-Started/Getting-started-with-decision-services/dmn-datatype-constraints-tickmark.png[] to save each enumeration constraint that you add.
+
* `"speed"`
* `"parking"`
...
image::DMN-source/Getting-Started/Getting-started-with-decision-services/dmn-tFine-custom-datatype.png[]
...
.Fine decision table
image::DMN-source/Getting-Started/Getting-started-with-decision-services/dmn-gs-fine-decision-table.png[]

.Should the driver be suspended?
image::DMN-source/Getting-Started/Getting-started-with-decision-services/dmn-gs-context-table.png[]
