...
image::{images-dir}/dmn-traffic-violations-drd.png[]
...
image::{images-dir}/dmn-custom-datatypes-tab.png[]
...
image::{images-dir}/dmn-diagram-properties-tab.png[]
...
image::{images-dir}/dmn-tDriver-custom-datatype.png[]
...
image::{images-dir}/dmn-tViolation-custom-datatype.png[]
...
. To add the following constraints to the `Type` nested data type, click *Edit* -> *Constraints* -> *Enumeration* and add the following constraints. Click the check icon image:{images-dir}/dmn-datatype-constraints-tickmark.png[] to save each enumeration constraint that you add.
+
* `"speed"`
* `"parking"`
...
image::{images-dir}/dmn-tFine-custom-datatype.png[]
...
.Fine decision table
image::{images-dir}/dmn-gs-fine-decision-table.png[]

.Should the driver be suspended?
image::{images-dir}/dmn-gs-context-table.png[]
