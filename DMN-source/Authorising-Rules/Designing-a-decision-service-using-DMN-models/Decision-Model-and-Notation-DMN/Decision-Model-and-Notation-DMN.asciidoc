...
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-node.png[]
...
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-bkm-node.png[]
...
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-knowledge-source-node.png[]
...
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-input-data-node.png[]
...
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-service-node.png[]
...
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-info-connector.png[]
...
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-knowledge-connector.png[]
...
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-authority-connector.png[]

.2+|Artifacts
|Text annotation
|Explanatory note associated with an input data node, decision node, business knowledge model, or knowledge source.
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-annotation-node.png[]

|Association
|Connection from an input data node, decision node, business knowledge model, or knowledge source to a text annotation.
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-association-connector.png[]
|===
...
|Information requirement
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-to-decision.png[]

.2+|Business knowledge model
|Decision
.2+|Knowledge requirement
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-bkm-to-decision.png[]

|Business knowledge model
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-bkm-to-bkm.png[]
...
.2+|Knowledge requirement
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-service-to-decision.png[]

|Business knowledge model
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-service-to-bkm.png[]

.2+|Input data
|Decision
|Information requirement
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-input-to-decision.png[]

|Knowledge source
|Authority requirement
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-input-to-knowledge-source.png[]

.3+|Knowledge source
|Decision
.3+|Authority requirement
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-knowledge-source-to-decision.png[]

|Business knowledge model
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-knowledge-source-to-bkm.png[]

|Knowledge source
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-knowledge-source-to-knowledge-source.png[]

|Decision
.4+|Text annotation
.4+|Association
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-to-annotation.png[]

|Business knowledge model
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-bkm-to-annotation.png[]

|Knowledge source
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-knowledge-source-to-annotation.png[]

|Input data
a|
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-input-to-annotation.png[]
|===

The following example DRD illustrates some of these DMN components in practice:

.Example DRD: Loan prequalification
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-example-drd.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-example-drd3.png[width=90%]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-table-example.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-table-example2.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-table-example3.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-literal-expression-example2.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-literal-expression-example3b.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-context-expression-example.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-context-expression-example2.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-relation-expression-example.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-function-expression-example.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-function-expression-example2.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-function-expression-example3.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-invocation-example.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-invocation-example2.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-passenger-rebooking-drd.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-reassign-passenger.png[]
