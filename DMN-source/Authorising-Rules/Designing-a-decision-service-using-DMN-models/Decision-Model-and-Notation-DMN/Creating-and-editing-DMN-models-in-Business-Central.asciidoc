...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-drag-decision-node.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-edit.png[]

.Opening a new business knowledge model boxed expression
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-bkm-edit.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-boxed-expression-options.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-bkm-define.png[]
--
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-decision-table-example1a.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-function-expression-example4.png[]
////
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-input-connection-example.png[]

image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-input-connection-example2.png[]
--
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-manage-data-types.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-custom-data-type-constraints.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-hit-policies.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-manage-data-types1a.png[]
...
.Decision table for loan prequalification
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-manage-data-types-blank.png[]
--
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-manage-data-types-structured.png[]
--
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-manage-data-types-structured2.png[]
--
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-manage-data-types-structured3.png[]

.Custom data type definitions for online dating compatibility
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-manage-data-types-structured3a.png[]

.Parameter definitions with custom data types for online dating compatibility
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-manage-data-types-structured3b.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-include-model.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-include-model-list.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-include-model-data-types.png[]
--
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-include-model-drd.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-designer-project-view.png[]

.Decision Navigator view
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-designer-nav-view.png[]

image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-designer-nav-view2.png[]
...
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-designer-preview.png[]
--
...
--
.DRD node properties
image::DMN-source/Authorising-Rules/Designing-a-decision-service-using-DMN-models/Decision-Model-Notation-DMN/dmn-designer-properties.png[]
