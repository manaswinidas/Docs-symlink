...
[id="chap-kogito-decision-engine_{context}"]
...
include::modules/decision-engine/con-phreak-rule-evaluation.adoc[leveloffset=+1]

include::modules/decision-engine/con-forward-and-backward-chaining.adoc[leveloffset=+2]

include::modules/decision-engine/con-property-change-listeners.adoc[leveloffset=+1]
